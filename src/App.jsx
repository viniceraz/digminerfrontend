  ...
  <div style={{animation:"fadeIn .3s ease",display:"flex",gap:0,background:"#fff",borderRadius:16,border:"1px solid #e0e0e0",overflow:"visible",minHeight:640,alignItems:"flex-start"}}>
    ...
    <div style={{flex:1,padding:"32px 36px 40px",minWidth:0}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(140px,1fr))",gap:10,marginBottom:28}}>
        {[[tx.howStatExchange,"100 DC = 1 pathUSD","#FF9800"],[tx.howStatBox,"300 DC (single)","#2196F3"],[tx.howStatBulk,"2850 DC — 5% off","#4CAF50"],[tx.howStatFee,"6%","#E91E63"],[tx.howStatRef,"4% of deposit","#9C27B0"],[tx.howStatBatch,"10 DC / miner","#FF9800"]].map(([l,v,c])=>(
