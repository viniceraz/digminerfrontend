...
const T = {
  ...
  zh:{
    ...
    howFusionTitle:"合成",howFusionP:"合成允许您牺牲2个相同稀有度的矿工，锻造一个更高阶的更强矿工。两个原始矿工永久销毁。合成矿工日收益比两个父矿工合计多20%。初始寿命为两个父矿工剩余次数的平均值——但首次修复后将完全恢复为结果稀有度的最大寿命。",howFusionWarn:(c)=>`费用：${c} DIGCOIN · 仅限相同稀有度 · 两个矿工必须处于空闲状态 · 合成矿工不可再次合成`,howFusionRuleTitle:"⚗️ 合成公式",howFusionTableTitle:"📈 所有可能结果",howFusionColA:"矿工 A",howFusionColB:"矿工 B",howFusionColResult:"结果",howFusionColDaily:"日收益（示例）",howFusionColLifespan:"寿命",howFusionHowTitle:"🔥 如何合成",howFusionSteps:[["前往我的NFT标签","确保要合成的2个矿工均处于空闲状态（未在挖矿）。"],["点击 🔥 合成矿工","出现紫色横幅，仅空闲、相同稀有度、未合成过的矿工可被选择。"],["选择2个相同稀有度矿工","点击2张相同稀有度的卡片 — 它们将以紫色边框高亮。"],["点击 🔥 立即合成（50 DC）","扣除50 DC，两个矿工被销毁，更强的矿工被创建。"],["观看展示动画","特殊的 ⚗️ 合成结果界面将显示您新矿工的强化属性。"]],howFusionTip:"最佳策略：合成日收益高的矿工以最大化加成输出。两个日收益20 DC的普通矿工合成后将产出48 DC/天的非普通矿工——是普通非普通矿工的两倍多。",
    ...
    <div className="how-content">
      ...
      <div style={{overflowX:"auto",marginBottom:22}}>
        <table style={{width:"100%",borderCollapse:"collapse",fontSize:12}}>
          ...
          <tbody>
            {[
              [0,0,1,"(19+19)×1.2 = 45.6 DC"],
              [1,1,2,"(22+22)×1.2 = 52.8 DC"],
              [2,2,3,"(25+25)×1.2 = 60 DC"],
              [3,3,4,"(28+28)×1.2 = 67.2 DC"],
              [4,4,5,"(33+33)×1.2 = 79.2 DC"],
            ].map(([aId,bId,resId,daily],i)=>{
              ...
              return(
                <tr key={i} style={{background:i%2===0?"#f8f9fa":"#fff",borderBottom:"1px solid #eee"}}>
                  ...
                  <td style={{padding:"10px 12px"}}>
                    <div style={{color:"#aaa",fontSize:10,marginBottom:2}}>Born: avg of parents</div>
                    <div style={{color:"#FF9800",fontWeight:700}}>After repair: {cr.nftAge} days</div>
                  </td>
                </tr>
              );
            })}
